...
mod tests {
    ...
    #[test]
    fn test_accepts() {
        let raw_transport = Box::new(raw::RawTransport::new().expect("Unable to create transport"));
    ...
    fn test_outbound_raw_only() {
        test_outgoing_connections(raw::RawTransport::new().expect("Unable to create transport"), "127.0.0.1:0", {
            let raw_transport = Box::new(raw::RawTransport::new().expect("Unable to create transport"));
            let tls_transport = Box::new(create_test_tls_transport(true));
